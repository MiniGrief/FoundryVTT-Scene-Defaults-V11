...
# Compatibility
* **Foundry Version**: Scene Defaults is compatible with Foundry VTT 0.6.6 through 0.7.6, and is safe to use with newer versions as well. (The window for editing scene defaults might get funky, though.)
